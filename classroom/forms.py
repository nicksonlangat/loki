...
class StudentSignUpForm(UserCreationForm):
	firstname = forms.CharField(max_length=30,widget=forms.TextInput(attrs={ 'type': 'text',   'class': 'form-control',   } ), label = "First name",)
	...
	def save(self):
		...
		student.interests.add(*self.cleaned_data.get('applications'))
		return user
